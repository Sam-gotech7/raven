    ...
    return <div className="raven-header">
        {selectedChannel ? <ChannelHeader channelID={selectedChannel} onBackClick={closeChannel} /> :
            <div style={{
                ...
                <span role='button' className="raven-logo cal-sans" onClick={toggle}>Redee Chat</span>
...
const ChannelHeader = ({ channelID, onBackClick }) => {
    ...
    return <div className="raven-channel-header">
        ...
        {channel?.is_direct_message ? <DMChannelHeader channel={channel} /> :
            <a href={`/raven/channel/${channelID}`} target="_blank" title="Open channel in Redee Chat">
...
const DMChannelHeader = ({ channel }) => {
    ...
    return <a title="Open channel in Redee Chat" className="raven-dm-channel-header" href={`/raven/channel/${channel.name}`} target="_blank">
