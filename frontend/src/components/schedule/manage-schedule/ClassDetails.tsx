    ...
    <Box className="p-6 text-gray-100 shadow-lg w-full">
      ...
      <Flex direction="column" gap="2" className="w-full">
        <Flex justify="between" mb="2">
          ...
          <Text color="gray">{data?.class_category}</Text>
        </Flex>
        ...
        <Flex justify="between" mb="2">
          ...
          <Text color="gray">{data?.schedule_date}</Text>
        </Flex>
        ...
        <Flex justify="between" mb="2">
          ...
          <Text color="gray">{data?.company}</Text>
        </Flex>
        ...
        <Flex justify="between" mb="2">
          ...
          <Text color="gray">{data?.booked_seats} / {data?.maximum_capacity} seats booked</Text>
        </Flex>

        <Flex justify="between">
          <Text weight="bold">Available Seats</Text>
          <Text color="gray">{data?.available_seats}</Text>
        </Flex>
      </Flex>
    </Box>
  );
